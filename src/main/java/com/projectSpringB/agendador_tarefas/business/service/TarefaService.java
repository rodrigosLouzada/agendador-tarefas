...
import com.projectSpringB.agendador_tarefas.business.mapper.TarefaUpdateConverter;
...
public class TarefaService {
    ...
    public TarefasDTO updateTarefa(String id, TarefasDTO tarefasDTO){
        TarefasEntity tarefa = tarefasRepository.findById(id).
                orElseThrow(()-> new ResourceNotFoundException("id nào encontrado"));
